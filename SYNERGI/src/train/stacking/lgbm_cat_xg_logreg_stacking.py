...
N_SPLITS = 5
N_CLASSES = 3
MODEL_NAME = "lgbm_xg_cat__logreg"

CSV_PATH = os.path.join(
    "./data/Illustris/Illustris_preprocess_SFR_-1.csv"
)

OUT_BASE_MODEL = "./model/stacking/SFR_inf_-1"
OUT_BASE_EVAL  = "./evaluation/stacking/SFR_inf_-1"
