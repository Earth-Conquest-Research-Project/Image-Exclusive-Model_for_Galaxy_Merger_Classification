...
save_dir_model = os.path.join(base_dir, "model/classicalMachineLearning/SFR_inf_remove", model_name)
save_dir_eval  = os.path.join(base_dir, "evaluation/classicalMachineLearning/SFR_inf_remove", model_name)
